...
namespace Puxbit.Infraestructura.Mapeos
{
    public class PadresMapeos:EntidadBaseMapeo<Padres>
    {
        public PadresMapeos():base("Padres")
        {
            ...
            Property(x => x.Telefono2).HasColumnName("Telefono2").HasColumnType("string").IsOptional();
            ...
            Property(x => x.Parentesco).HasColumnName("Parentesco").HasColumnType("string").IsRequired();
